...
class TutorialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post tutorials_url, params: { tutorial: { author: @tutorial.author, format: @tutorial.format, title: @tutorial.title, url: @tutorial.url, user_id: @tutorial.user_id } }
    end
  ...
  test "should update tutorial" do
    patch tutorial_url(@tutorial), params: { tutorial: { author: @tutorial.author, format: @tutorial.format, title: @tutorial.title, url: @tutorial.url, user_id: @tutorial.user_id } }
